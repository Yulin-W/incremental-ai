export default {
  ...
  "ui": {
    ...
    "brandSubtitle": "An Idle Game of AI History",
    "insights": "Insights",
    "perSecond": "per second",
    "clickGain": "+{amount} / click",
    "think": "Think",
    "buy": "Buy:",
    ...
    "language": "Language",
    "epoch": "Epoch {number}",
    "milestoneProgress": "{unlocked} / {total} Milestones ({pct}%)",
    "milestonesComplete": "All {total}/{total} Milestones Complete",
    "restartTimeline": "Restart Timeline",
    "epoch1Reset": "Epoch 1 (Reset)",
    "activeFocusRestart": "Active Focus • Restart",
    "standardReplay": "Standard Replay",
    "singularityReady": "Singularity Ready",
    "locked": "Locked",
    "discovered": "Discovered",
    "unlockCost": "Unlock: {cost} 💡",
    "buyCount": "Buy x{count}",
    "baseRateEach": "+{rate}/s each",
    "outputRate": "+{rate}/s",
    "activeBonus": "ACTIVE BONUS",
    "inactiveBonus": "INACTIVE BONUS",
    "unlockedArchived": "✓ Unlocked & Archived",
    "lockedEntry": "🔒 Locked Entry",
    "paradigmShiftLabel": "Paradigm Shift",
    "historicalLoreLabel": "Historical Lore & Scientific Context",
    "academicCitationLabel": "Primary Academic Citation",
    "gameplayImpactLabel": "Gameplay Economic Impact",
    "whileAwayTitle": "⏰ While You Were Away",
    "whileAwayMsg": "+{gain} 💡 generated over {duration}{cap}",
    "capNotice": " (4h cap)",
    "breakthroughToast": "✨ Breakthrough Unlocked!",
    "epochToast": "🏛️ Entering Epoch {id}: {name}",
    "singularityToastTitle": "🌌 Frontier Singularity Achieved!",
    "singularityToastMsg": "All 28 historical milestones discovered! Paradigm Shift is now unlocked.",
    "paradigmActivatedTitle": "🌌 Paradigm Shift Activated",
    "paradigmActivatedMsg": "Beginning historical cycle with {name}.",
    "continuingTimelineTitle": "🌌 Continuing Current Timeline",
    "continuingTimelineMsg": "Explore further or inspect the Codex. Paradigm Shift remains available in the header.",
    "hardResetToast": "🧹 Factory Reset Complete",
    "hardResetToastMsg": "All saved data and progress have been completely wiped.",
    "helpModalTitle": "Incremental AI",
    "helpModalSubtitle": "An Idle Game of AI History",
    "helpWhatIsTitle": "What is this game?",
    "helpWhatIsText": "An interactive idle game tracing the evolution of Artificial Intelligence across 7 historical epochs—from ancient automata to modern autonomous agents.",
    "helpHowToPlay": "How to Play",
    "helpStep1Title": "1. Think & Discover",
    "helpStep1Text": "Click Think to generate initial Insights manually.",
    "helpStep2Title": "2. Automate Production",
    "helpStep2Text": "Build historical tools (Calculators, Neural Nets) for passive rate/sec.",
    "helpStep3Title": "3. Unlock Milestones",
    "helpStep3Text": "Spend Insights on breakthroughs to boost multipliers and reach new Epochs.",
    "helpStep4Title": "4. Study the Codex",
    "helpStep4Text": "Select milestones to read verified academic history, lore, and citations.",
    "helpStep5Title": "5. The Singularity & Beyond",
    "helpStep5Text": "Completing all 7 Epochs opens mysterious frontier choices and replay bonuses.",
    "helpStep6Title": "6. Language Options",
    "helpStep6Text": "Switch between 9 supported world languages anytime via the 🌐 header menu.",
    "helpStartButton": "Got It — Start Exploring 🚀",
    "multiTabTitle": "Active in Another Tab",
    "multiTabDesc": "Incremental AI is currently active in another window or tab. The game loop in this tab has been safely paused to prevent save conflicts and duplicate progress.",
    "multiTabResume": "Resume in this Tab",
    "paradigmModalTitle": "Technological Singularity: Choose Your Paradigm",
    "paradigmModalSubtitle": "You have discovered all 28 historical milestones! Choose an AI Philosophy below to reincarnate history with specialized speed buffs (~2x faster), or replay unassisted.",
    "paradigmSingularityBadge": "🌌 TECHNOLOGICAL SINGULARITY REACHED",
    "paradigmEpochComplete": "Epoch 7 Complete",
    "paradigmVanillaTitle": "Standard Historical Replay",
    "paradigmVanillaDesc": "Replay history with pure vanilla balancing and no research buffs.",
    "btnStayTimeline": "🌌 \"Just One More Insight...\"",
    "btnStayTimelineSub": "Continue in current timeline (You can Paradigm Shift anytime from the top-right header button)",
    "btnRequestPurge": "🧹 Clear All Saved Memory & Hard Reset (Wipe Local Storage)",
    "confirmShiftBadge": "⚠️ CONFIRM PARADIGM SHIFT",
    "confirmRestartBadge": "⚠️ CONFIRM TIMELINE RESTART",
    "confirmPurgeBadge": "⚠️ CONFIRM FACTORY PURGE",
    "confirmShiftTitle": "Shift to {name}?",
    "confirmShiftDesc": "This will restart the historical timeline from Epoch 1 with your chosen AI research bonuses active (~2x speed).",
    "confirmRestartTitle": "Restart Historical Timeline?",
    "confirmRestartDesc": "This will reset your current timeline back to Epoch 1 (Antiquity). Any progress toward the Singularity in this run will reset.",
    "confirmPurgeTitle": "Factory Reset & Wipe All Data?",
    "confirmPurgeDesc": "This will permanently delete ALL saved game data, Singularity unlocks, completed paradigms, and achievements from your browser. This action CANNOT be undone.",
    "confirmActiveBuffs": "⚡ ACTIVE BUFFS FOR NEXT RUN:",
    "confirmWarningReset": "Current insights, generators, and milestone discoveries will reset to Epoch 1.",
    "confirmWarningPurge": "WARNING: This will permanently wipe all local storage save files.",
    "btnCancelConfirm": "✕ Stay in Current Timeline",
    "btnExecuteShift": "🚀 Confirm & Reincarnate →",
    "btnExecuteRestart": "🚀 Yes, Reset Timeline →",
    "btnExecutePurge": "💥 Yes, Wipe All Data",
    "eventEpochCategory": "NEW EPOCH REACHED",
    "confirmParadigmShiftBadge": "CONFIRM PARADIGM SHIFT",
    "activeBuffsHeader": "ACTIVE BUFFS FOR NEXT RUN",
    "resetWarningEpoch1": "Current insights, generators, and milestone discoveries will reset to Epoch 1.",
    "confirmReincarnateBtn": "Confirm & Reincarnate →",
    "shiftToTitle": "Shift to {name}?",
    "shiftToDesc": "Restart history from Epoch 1 aligned with {name}. Your new run will progress ~2x faster.",
    "restartStandardTitle": "Restart Standard Historical Run?",
    "restartStandardDesc": "Restart history from Epoch 1 in authentic unassisted mode with standard 1x baseline speed.",
    "restartStandardEffects": "Standard baseline speed; No active doctrine buffs or discounts.",
    "restartTimelineBadge": "RESTART TIMELINE",
    "restartTimelineTitle": "Restart Timeline from Epoch 1?",
    "restartTimelineDesc": "This will reset your current insights, historical automation, and milestone discoveries back to Epoch 1: Antiquity.",
    "singularityProgressionHeader": "SINGULARITY PROGRESSION",
    "singularityProgressionText": "Complete all 7 Epochs once to achieve the Technological Singularity. Clearing the game permanently upgrades this button into <strong>AI Paradigm Shifts</strong> with ~2x speed boosts!",
    "metaPreservedWarning": "Active run progress will restart, but any unlocked meta achievements are preserved.",
    "confirmRestartBtn": "Confirm & Restart →",
    "purgeDataBadge": "HARD RESET & PURGE",
    "purgeDataTitle": "Permanently Erase All Saved Data?",
    "purgeDataDesc": "This will wipe all local storage data from your browser, removing all unlocked paradigms, lifetime insights, and progress back to Day 1.",
    "purgeDataHeader": "LOCAL BROWSER STORAGE PURGE",
    "purgeDataText": "All saves will be deleted from <code>localStorage</code>. The game resets to a brand-new factory state without needing to clear browser history.",
    "purgeDataWarning": "Warning: This action is permanent and cannot be undone!",
    "purgeDataBtn": "Erase All Data & Hard Reset",
    "replayBuffsLabel": "REPLAY BUFFS (~2x SPEED)",
    "selectInitiateShift": "Select & Initiate Shift →",
    "mastered": "Mastered",
    "vanillaReplayName": "Standard Historical Replay (No Paradigm Buffs)",
    "vanillaReplaySubtitle": "Authentic Unassisted Timeline (1600s – Present)",
  ...
  "milestones": {
    "ms_talos": {
      ...
      "effectsDescription": "Doubles active Think insight yield."
    },
    "ms_aristotle_logic": {
      ...
      "effectsDescription": "Scholastic Scribes produce +150% more Insights."
    },
    "ms_heron_automata": {
      ...
      "effectsDescription": "Clepsydra & Cam Mechanisms produce +200% more Insights."
    },
    "ms_llull_ars_magna": {
      ...
      "effectsDescription": "Doubles all Insight production across Epoch 1."
    },
    "ms_pascaline": {
      ...
      "effectsDescription": "Active clicks yield +150% more; Stepped Drum Calculators produce 2x."
    },
    "ms_leibniz_calculus": {
      ...
      "effectsDescription": "Doubles all passive Insight generation."
    },
    "ms_analytical_engine": {
      ...
      "effectsDescription": "Babbage Difference Engines produce +200% more Insights."
    },
    "ms_lovelace_algorithm": {
      ...
      "effectsDescription": "Increases global Insight generation by +150% and doubles click power."
    },
    "ms_turing_machine": {
      ...
      "effectsDescription": "Doubles global rate and boosts Relay Computers by +150%."
    },
    "ms_mcculloch_pitts": {
      ...
      "effectsDescription": "Vacuum Tube Banks produce +200% more Insights."
    },
    "ms_turing_test": {
      ...
      "effectsDescription": "Triples active Think Insight yield."
    },
    "ms_dartmouth_1956": {
      ...
      "effectsDescription": "Triples all Insight generation across the entire system."
    },
    "ms_logic_theorist": {
      ...
      "effectsDescription": "LISP Workstations produce +150% more Insights."
    },
    "ms_eliza": {
      ...
      "effectsDescription": "Active Think yield increased by +150%."
    },
    "ms_expert_systems": {
      ...
      "effectsDescription": "Production Rule Engines produce +200% more Insights."
    },
    "ms_ai_winter_survival": {
      ...
      "effectsDescription": "Increases global Insight production by +150%."
    },
    "ms_backprop_revival": {
      ...
      "effectsDescription": "Doubles global rate and boosts Backpropagation Rigs by +200%."
    },
    "ms_support_vector_machines": {
      ...
      "effectsDescription": "Support Vector Kernel Clusters produce +200% more Insights."
    },
    "ms_deep_blue": {
      ...
      "effectsDescription": "Triples active Think click power."
    },
    ...
    "ms_alexnet": {
      ...
      "effectsDescription": "Parallel GPU Farms produce +300% more Insights."
    },
    "ms_dqn_atari": {
      ...
      "effectsDescription": "Active Think yield increased by +250%."
    },
    "ms_alphago": {
    ...
    "ms_transformer_attention": {
      ...
      "effectsDescription": "Multi-Head Attention Clusters produce 4x; Global rate +150%."
    },
    "ms_rlhf_alignment": {
      ...
      "effectsDescription": "Active Think yield multiplied by 4x."
    },
    "ms_chain_of_thought": {
      ...
      "effectsDescription": "Deliberative Reasoning Engines produce +300% more Insights."
    },
    "ms_tool_augmented_mcp": {
      ...
      "effectsDescription": "Tool-Augmented Agent Swarms produce 4x; Global rate tripled."
    },
    "ms_autonomous_agent_swarms": {
      ...
      "effectsDescription": "Global Insight production multiplied by 5x! Epoch 7 Singularity achieved!"
    }
  },
  "events": {
    "1": {
